...
public class EmailAuthController {
    ...
    @PostMapping("/send")
    public CustomResponse<String> sendEmailAuthCode(@RequestBody EmailRequestDto.SendEmailRequestDto dto) {
        emailAuthService.sendEmailAuthCode(dto.email()); // 이메일 인증 코드 전송 로직을 실행
